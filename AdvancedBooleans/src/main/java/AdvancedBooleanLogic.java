...
public class AdvancedBooleanLogic {
    ...
    public boolean returnNotBoth(boolean b1, boolean b2) {
        if (b1 && b2) {
            return false; // b1 and b2 are both true
        } else {
            return true; // b1 and b2 are not both true
        }
    }
    ...
    public boolean returnExclusiveOr(boolean b1, boolean b2) {
        if (b1 ^ b2) {
            return true; // either b1 or b2 is true
        } else {
            return false; // both b1 and b2 are true or both are false
        }
    }
    ...
    public boolean returnNeitherNor(boolean b1, boolean b2) {
        if (!b1 && !b2) {
            return true; // neither b1 nor b2 is true
        } else {
            return false; // either b1 or b2 is true
        }
    }
